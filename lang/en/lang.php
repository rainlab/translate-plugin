...
return [
    ...
    'locale' => [
        ...
        'code' => 'Code',
        'is_default' => 'Default',
        'is_default_help' => 'Disabled languages will not be available in the front-end.',
        'is_enabled' => 'Enabled',
        'is_enabled_help' => 'The default language represents the content before translation.',
